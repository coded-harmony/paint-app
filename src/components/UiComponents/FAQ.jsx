...
const Faq = () => {
    ...
    return (
        <main>
            <div className="faq-bg relative py-[270px] z-[1] max-lg:overflow-hidden max-lg:bg-[#262626] max-lg:py-20">
                <div className="container">
                    <h2 className="text-center text-white max-sm:mb-5">Phasellus a vitae iaculis magna.</h2>
                    <h3 className='text-center mb-20 text-white max-sm:mb-10 max-sm:text-[16px]'>Phasellus a vitae iaculis magna eleifend pulvinar velit odio.</h3>
                    <div className="w-full">
                        {faqData.map((item, index) => (
                            <div key={index} className="bg-white rounded-[40px] text-black py-10 px-16 mb-6 max-sm:p-7">
                                <div
